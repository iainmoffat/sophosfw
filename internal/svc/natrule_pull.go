...
// UpdateInline updates an existing NATRule from an in-memory body. See
// FirewallRuleSvc.UpdateInline for shape; this is the NAT mirror.
// Audit op: nat_rule_push.
